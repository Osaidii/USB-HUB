...
13. Then you need to scroll all the way down and turn on PCB Assembly and select 5 as PCB Assembly Quantity, Now you can also select any coupons from the bottom as there are many coupons that give discounts (you can only select one coupons for one transaction). 
...
18. Then you can upload Enclosure.obj file in the first option.
